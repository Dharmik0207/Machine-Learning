...
# dec_rmse = np.sqrt(root_mean_squared_error(housing_labels, dec_preds))
...
# Random_forest_rmse = np.sqrt(root_mean_squared_error(housing_labels, Random_forest_preds))
